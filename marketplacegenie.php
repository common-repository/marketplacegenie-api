...
if (in_array('woocommerce/woocommerce.php', apply_filters('active_plugins', get_option('active_plugins')))) {
    ...
    function marketplacegenie_wooCommerceMenu()
    {
        ...
        add_submenu_page('marketplacegenie', 'Settings', 'Settings', 'manage_options', 'marketplacegenie');
        add_submenu_page('marketplacegenie', 'Logs', 'Logs', 'manage_options', 'marketplacegenie');
        add_submenu_page('marketplacegenie', 'Licensing', 'Licensing', 'manage_options', 'marketplacegenie');
        add_submenu_page('marketplacegenie', 'Support', 'Support', 'manage_options', 'marketplacegenie');
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    <div id="wf-onboarding-fresh-install" class="wf-onboarding-modal">
     <form id="sendmyForm" method="post" action="admin.php?page=marketplacegenie&sendmail=sendmail">
            ...
            <div id="wf-onboarding-fresh-install-1" class="wf-onboarding-modal-content">
                ...
                <h3> Please fill out the below form and a sales representative will contact you to setup your Marketplace Genie Account.<br><br>   </h3>
                <div id="wf-onboarding-license">
                 <input type="text"   placeholder="Name" style="min-width: 300px;" id="name" name="name"   /> <br>
                <input type="text"   placeholder="Company Name" style="min-width: 300px;" id="company" name="company"   />  <br>
                  <input type="text"   placeholder="Takealot Seller URL" style="min-width: 300px;" id="sellerurl" name="sellerurl"   /> <br>
                 <input type="email"   placeholder="Email Address" style="min-width: 300px;" id="email" name="email"   /> <br>
               <input type="text"   placeholder="Telephone Number" style="min-width: 300px;" id="tel" name="tel"   /> <br>
                <input type="text"   placeholder="Website Address" style="min-width: 300px;" id="website" name="website"   /><br>
                 <input type="number"   placeholder="Products Number" style="min-width: 300px;" id="products" name="products"   />
             </div>
                <div id="wf-onboarding-footer">
                   ...
                   <li><a  onclick="sendform() ; return false;"  href ="" class="primary button" style ="width:200px;" id="wf-onboarding-continue"> Submit </a></li>
                    </ul>
                </div>
...
function sendform() 
{
 document.getElementById("sendmyForm").submit();
 console.error("Email Send ");
var name = document.getElementById("name").value;
var company = document.getElementById("company").value;
var sellerurl = document.getElementById("sellerurl").value;
  ...
  ';
    ...
    function marketplacegenie_wooCommerceOptions()
    {
        ...
        if (isset($_GET['sendmail'])) {
            ...
            $sellerurl = $_POST["sellerurl"];
            $email = $_POST["email"];
            $tel = $_POST["tel"];
            $website = $_POST["website"];
            $products = $_POST["products"];
            $body = "<br> <strong>  Name<strong/> : " . $name;
            $body = $body ."<br> <strong>  Name<strong/> : " . $name;
            $body = $body ."<br> <strong>  Email<strong/> : " . $email;
            $body = $body ." <br><strong>  Company<strong/> : " . $company;
            $body = $body ." <br><strong>   Seller Url<strong/> : " . $sellerurl;
            $body = $body ." <br><strong>  Tel<strong/> : " . $tel;
            $body = $body ." <br><strong>  Website<strong/> : " . $website;
            $body = $body ." <br><strong>  Products<strong/> : " . $products;
            $headersx ='Content-Type: text/html; charset=UTF-8';
            $headers[] = $headersx;

            wp_mail( "info@marketplacegenie.co.za", "New MArketplace Genie APp Enquiry", $body, $headers );
            echo "<script>alert('Thank you. Email Send!!!!!')</script>";
